...
<main>
    <div class="container mx-auto px-4">
        <h1 class="my-5 text-3xl text-center"><?= __('change_password') ?></h1>


        <div class="bg-white py-3 px-4 lg:p-8 border border-gray-300 rounded shadow-sm max-w-2xl mx-auto">
            <p class="mb-5 text-gray-600">
                Въведете новата си парола, за да възстановите достъпа до профила си. Линкът за смяна на паролата е
                валиден само 1 час, така че го използвайте навреме.
            </p>

            <form action="/users/change-password" method="POST" class="space-y-4">
                <div>
                    <label for="password" class="block"><?= __('new_password') ?></label>
                ...
                <div>
                    <label for="confirm_password" class="block"><?= __('confirm_password') ?></label>
